...
entity Cars {
    key licensePlate : String @assert.unique;
        ...
        maintenance  : Association to many Maintenance on maintenance.car = $self;
}

entity Customers {
    key driverLicense : String(50) @assert.unique;
        email         : String(100) @assert.unique  @mandatory;
